...
INSERT INTO Dogs (registration_number, name, breed, born_date, sex, father_id, mother_id, owner_id, litters, championship_title, best_test, best_show, litter_score, score_trace, hip_index, use_index) VALUES
    ('FI28691/21', 'Dolly', 'Finnish Spitz', '2020-01-01', 'M', NULL, NULL, 1, NULL, 'KVA', 1, 'Spring Dog Show', 'A+', 'Trace1', 85, 90),
    ('FI28692/21', 'Bella', 'Afghan Hound', '2019-05-10', 'F', NULL, NULL, 2, NULL, 'KV', 2, 'Summer Dog Show', 'A', 'Trace2', 80, 85),
    ('FI28693/21', 'Charlie', 'Africanis', '2021-03-20', 'M', NULL, NULL, 3, NULL, 'KVA2', 3, 'Autumn Dog Show', 'B+', 'Trace3', 75, 80),
    ('FI28694/21', 'Daisy', 'Aidi', '2018-07-15', 'F', NULL, NULL, 4, NULL, 'KV2', 4, 'Winter Dog Show', 'B', 'Trace4', 70, 75),
    ('FI28695/21', 'Max', 'Airedale Terrier', '2020-11-30', 'M', NULL, NULL, 5, NULL, 'KVA3', 5, 'Spring Dog Show', 'C+', 'Trace5', 65, 70);
